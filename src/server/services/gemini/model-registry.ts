...
export const MODEL_REGISTRY: ModelDef[] = [
  ...
  // ── Claude models (Vertex AI) — admiral-only ──────────────
  {
    ...
    provider: "claude",
    tier: "balanced",
    description: "Anthropic's fastest model. Quick responses, low cost. Admiral only.",
    thinking: false,
  ...
  },
  {
    ...
    provider: "claude",
    tier: "premium",
    description: "Anthropic's strongest reasoning model. Deep analysis & complex tasks. Admiral only.",
    thinking: true,
    contextWindow: 200_000,
    costRelative: 4,
    speed: "moderate",
