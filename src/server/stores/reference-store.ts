 ...
 * Officers are sourced from structured datamine (raw-officers.json).
...
export interface ReferenceOfficer {
  ...
  /** Structured ability data from datamine (JSONB) */
  abilities: Record<string, unknown> | null;
  /** Activity suitability tags from datamine (JSONB) */
  tags: Record<string, unknown> | null;
  /** Stable numeric game ID from datamine */
...
const DEFAULT_ATTRIBUTION = "STFC community datamine";
...
const SCHEMA_STATEMENTS = [
  `CREATE TABLE IF NOT EXISTS reference_officers (
    ...
    attribution TEXT NOT NULL DEFAULT 'STFC community datamine',
