  ...
  router.get("/api", (_req, res) => {
    sendOk(res, {
      ...
      endpoints: [
        ...
        { method: "POST", path: "/api/import/analyze", auth: "lieutenant", description: "Analyze CSV/XLSX and suggest column mappings with sample rows" },
        { method: "POST", path: "/api/import/parse", auth: "lieutenant", description: "Parse CSV/XLSX into headers and rows" },
