  ...
  router.get("/api", (_req, res) => {
    res.json({
      ...
      endpoints: [
        ...
        { method: "GET", path: "/api/fleet/presets", description: "List crew presets (filterable)", params: { query: { shipId: "string?", intentKey: "string?", tag: "string?", officerId: "string?" } } },
        { method: "GET", path: "/api/fleet/presets/:id", description: "Get a single crew preset with members and tags" },
        ...
        { method: "PUT", path: "/api/fleet/presets/:id/tags", description: "Set preset tags (full replace)", params: { body: { tags: "string[]" } } },
        { method: "GET", path: "/api/fleet/tags", description: "List all unique preset tags" },
        { method: "GET", path: "/api/fleet/docks/:num/presets", description: "Find presets relevant to a dock (by ship + intent intersection)" },
